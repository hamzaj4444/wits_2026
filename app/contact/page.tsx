    ...
    <div className="min-h-screen bg-white text-gray-900 pt-20">
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          {/* Conference Location */}
          <Card className="bg-white border border-gray-400 hover:bg-gray-200 hover:border-gray-900 shadow-sm transition-all duration-100">
            <CardHeader>
            ...
            <Card className="bg-white border border-gray-400 hover:bg-gray-200 hover:border-gray-900 shadow-sm transition-all duration-100">
              ...
              <CardContent className="space-y-6 text-gray-800">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="text-gray-900 font-semibold mb-2">Time Zone</h4>
                    <p>{data.quickFacts.timezone}</p>
                  </div>
                  <div>
                    <h4 className="text-gray-900 font-semibold mb-2">Language</h4>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {data.contacts.map((contact: any, index: number) => (
            <Card
              key={index}
              className="bg-white border border-gray-400 hover:bg-gray-200 hover:border-gray-900 shadow-sm transition-all duration-100"
            >
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-800 mb-2">{contact.name}</p>
                <p className="text-gray-600 text-sm mb-4">{contact.role}</p>
                <div className="space-y-2">
                  {contact.email && (
                    <a
                      href={`mailto:${contact.email}`}
                      className="block text-gray-900 hover:text-blue-700 transition-colors font-medium"
                    >
                      {contact.email}
                    </a>
                  )}
        ...
        <Card className="bg-white border border-gray-400 hover:bg-gray-200 hover:border-gray-900 shadow-sm transition-all duration-100">
          <CardHeader>
            <CardTitle className="text-gray-900 text-3xl tracking-tight">
